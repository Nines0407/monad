...
import { z } from 'zod';
import { IntegrationError } from '@agent-pay/shared';
...
class MCPServer {
    ...
    // Tool handlers
    async handleRequestPayment(args, _context) {
    ...
    async handleCheckBudget(_args, _context) {
    ...
    async handleGetPaymentStatus(args, _context) {
    ...
    async handleListPayments(args, _context) {
    ...
    async handleUpdatePermissions(args, _context) {
    ...
    async handleEmergencyPause(args, _context) {
